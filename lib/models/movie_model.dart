class MovieModel {
  ...
  set isFavorite(bool isFavorite) => _isFavorite = _isFavorite;
  ...
  MovieModel.fromJson(Map<String, dynamic> json) {
    ...
    _isFavorite = json['IsFavorite']==null?false:json['IsFavorite'];
  }
  ...
  /*Map<String, dynamic> toJson() {
    ...
    if (this._title!=null){
      data['Title'] = this._title??null;
    }

    data['Year'] = this._year??null;

    data['Poster'] = this._poster??null;

    data['imdbID'] = this._imdbID??null;
    data['Type'] = this._type??null;
